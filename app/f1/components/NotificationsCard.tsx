...
export default function NotificationsCard({ user, canEdit, prefs, onToggle, onLoginRequest }: Props) {
  return (
    <div>
      ...
      {!user ? (
        /* â”€â”€ Collapsed state — not logged in â”€â”€ */
        <button
        ...
        >
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-sm text-slate-300 font-medium leading-tight">Sign in to configure F1 alerts</p>
              <p className="text-[11px] text-slate-500 mt-0.5">Set up push notifications for qualifying and race updates.</p>
            </div>
        ...
        /* â”€â”€ Expanded state — logged in with permission â”€â”€ */
        <>
