...
const NOTIF_MAP: Record<string, NotifEntry> = {
  ...
  fedDecision: { prefCol: "fed_decision", dbType: "fed_decision", keywords: ["fomc", "federal funds rate", "interest rate decision"] },
  gdpRelease:  { prefCol: "gdp_release",  dbType: "gdp_release",  keywords: ["gdp", "gross domestic product"] },
  jobsReport:  { prefCol: "jobs_report",  dbType: "jobs_report",  keywords: ["nonfarm payroll", "nfp", "employment situation"] },
